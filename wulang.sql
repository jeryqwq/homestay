...
CREATE TABLE `comment` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `conetext` varchar(500) DEFAULT NULL,
  `uId` int(6) DEFAULT NULL,
  `starts` int(1) NOT NULL DEFAULT '5',
...
INSERT INTO `homeinfo` VALUES ('2', '2', '1', '测试上传2', ' 这又是一款很牛逼的车车啊123', '0', '130000', '0.451877588710045.png', '0.451877588710045.png,0.451877588710045.png,0.3934990624230239.png', '<p>setImg</p><p><img src=\"https://gw.alipayobjects.com/zos/rmsportal/tXlLQhLvkEelMstLyHiN.svg\"></p><p><img src=\"https://gw.alipayobjects.com/zos/rmsportal/tXlLQhLvkEelMstLyHiN.svg\"></p>', '49', '2019-02-11 17:46:23', null, null, '1');
INSERT INTO `homeinfo` VALUES ('3', '4', '1', '测试三', '折还是一辆很牛逼的车', '1', '230000', '0.21606447077867896.png', ',0.21606447077867896.png', '<p>this.state.<img src=\"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png\"></p>', '2', '2019-02-11 17:46:27', null, null, '1');
INSERT INTO `homeinfo` VALUES ('4', '3', '1', '测试第三次', '前两次图片处理不正确，第三次修复', '1', '600000', '0.21606447077867896.png', ',0.21606447077867896.png', '<p><img src=\"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png\"></p>', '3', '2019-02-11 17:49:11', null, null, '1');
...
INSERT INTO `homeinfo` VALUES ('6', '3', '1', '第四次测试', '图片状态为修改完成就调用get请求，导致上传空数据', '0', '500000', '0.21606447077867896.png', ',0.21606447077867896.png', '<p>       axios.get(\"/addProduct\",{</p><p>              params:{</p><p>                  cateId:this.state.categoryId,</p><p>                  pingpai:this.state.pingpai,</p><p>                  title:this.state.title,</p><p>                  desc:this.state.desc,</p><p>                  status:this.state.status,</p><p>                  price:this.state.price,</p><p>                  img:this.state.subImg[0],</p><p>                  subImgs:this.state.subImg,</p><p>                  richText:this.state.text</p><p>              }</p><p>          }).then((res)=&gt;{</p><p>            console.log(res);</p><p>          })</p>', '4', '2019-02-11 17:49:06', null, null, '1');
...
INSERT INTO `homeinfo` VALUES ('15', '3', '20', '测试', '名宿测试', '1', '123', '0.04375480188906411.png', '0.7101916447474017.png,', '<p>mainImgmainImgaddress</p>', '29', '2019-02-25 15:57:58', '杭州', 'mainImgaddress', '1');
INSERT INTO `homeinfo` VALUES ('16', '5', '50', '民宿跟随用户ID外键', '测试民宿跟随用户ID外键描述', '1', '200', '0.44780192674265296.png', '0.8589484380240549.png,0.8707451431681188.jpg,', '<h1><strong>民宿跟随用户ID外键民宿跟随用户ID外键民宿跟随用户ID外键民宿跟随用户ID外键民宿跟随用户ID外键民宿跟随用户ID外键民宿跟随用户ID外键</strong></h1>', '4', '2019-02-25 17:19:20', '杭州', '民宿跟随用户ID外键地址', '1');
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('1', '15', '1', '7gdfgdf fg', '2019-02-11 00:00:00', '2019-02-20 00:00:00');
INSERT INTO `order` VALUES ('2', '15', '1', '7527272', '2019-02-25 16:24:02', '2019-02-28 16:24:08');
INSERT INTO `order` VALUES ('3', '15', '1', '123123', '2019-02-27 00:00:00', '2019-02-28 00:00:00');
INSERT INTO `order` VALUES ('4', '15', '1', '123123', '2019-02-27 00:00:00', '2019-02-28 00:00:00');
